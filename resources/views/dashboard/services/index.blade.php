        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.services') <small>{{ $services->total() }}</small></h3>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($services as $index=>$service)
                                <tr>
                                    ...
                                    <td><span></span>{{ $service->icon }}</td>

                                    <td>
                                            <a href="{{ route('dashboard.services.edit', $service->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
